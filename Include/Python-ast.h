...
enum _stmt_kind {FunctionDef_kind=1, AsyncFunctionDef_kind=2, ClassDef_kind=3,
                  ...
                  Question_kind=23, Pass_kind=24, Break_kind=25,
                  Continue_kind=26};
struct _stmt {
...
stmt_ty _Py_Expr(expr_ty value, int lineno, int col_offset, int end_lineno, int
                 end_col_offset, PyArena *arena);
#define Question(a0, a1, a2, a3, a4, a5) _Py_Question(a0, a1, a2, a3, a4, a5)
stmt_ty _Py_Question(expr_ty value, int lineno, int col_offset, int end_lineno,
                     int end_col_offset, PyArena *arena);
