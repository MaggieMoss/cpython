...
#define _loop0_12_type 1170
#define _gather_11_type 1171
#define _loop1_13_type 1172
#define _loop0_15_type 1173
#define _gather_14_type 1174
...
#define _loop1_24_type 1183
#define _tmp_25_type 1184
#define _tmp_26_type 1185
#define _loop0_28_type 1186
#define _gather_27_type 1187
#define _loop0_30_type 1188
#define _gather_29_type 1189
#define _tmp_31_type 1190
#define _tmp_32_type 1191
#define _loop0_33_type 1192
#define _loop1_34_type 1193
#define _loop0_36_type 1194
#define _gather_35_type 1195
#define _tmp_37_type 1196
#define _loop0_39_type 1197
#define _gather_38_type 1198
#define _tmp_40_type 1199
...
#define _loop0_76_type 1234
#define _gather_75_type 1235
...
#define _loop0_97_type 1255
#define _gather_96_type 1256
#define _tmp_98_type 1257
#define _tmp_99_type 1258
#define _tmp_100_type 1259
#define _tmp_101_type 1260
#define _loop1_102_type 1261
#define _tmp_103_type 1262
#define _tmp_104_type 1263
#define _loop0_106_type 1264
#define _gather_105_type 1265
#define _loop1_107_type 1266
#define _loop0_108_type 1267
#define _loop0_109_type 1268
#define _tmp_110_type 1269
#define _tmp_111_type 1270
...
#define _loop0_122_type 1280
#define _gather_121_type 1281
...
type_expressions_rule(Parser *p)
{
    ...
    { // '?'.expression+
        ...
        D(fprintf(stderr, "%*c> type_expressions[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'?'.expression+"));
        asdl_seq * _gather_11_var;
        if (
            (_gather_11_var = _gather_11_rule(p))  // '?'.expression+
        )
        {
            D(fprintf(stderr, "%*c+ type_expressions[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'?'.expression+"));
            _res = _gather_11_var;
...
simple_stmt_rule(Parser *p)
{
    ...
    { // ';'.small_stmt+ ';'? NEWLINE
        ...
        Token * newline_var;
        if (
            (a = _gather_14_rule(p))  // ';'.small_stmt+
            &&
...
invalid_lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* (lambda_slash_with_default | lambda_param_with_default+) lambda_param_no_default
        ...
        if (
            (_loop0_137_var = _loop0_137_rule(p))  // lambda_param_no_default*
            &&
            (_tmp_138_var = _tmp_138_rule(p))  // lambda_slash_with_default | lambda_param_with_default+
            &&
...
_gather_11_rule(Parser *p)
{
    ...
    { // expression _loop0_12
        ...
        D(fprintf(stderr, "%*c> _gather_11[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "expression _loop0_12"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = expression_rule(p))  // expression
        ...
        D(fprintf(stderr, "%*c%s _gather_11[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "expression _loop0_12"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_13_rule(Parser *p)
{
    ...
    { // statement
        ...
        D(fprintf(stderr, "%*c> _loop1_13[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "statement"));
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _loop1_13[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "statement"));
    }
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_13_type, _seq);
    D(p->level--);
    return _seq;
}

// _loop0_15: ';' small_stmt
static asdl_seq *
_loop0_15_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_15_type, _seq);
    D(p->level--);
    return _seq;
}

// _gather_14: small_stmt _loop0_15
static asdl_seq *
_gather_14_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // small_stmt _loop0_15
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_14[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "small_stmt _loop0_15"));
        stmt_ty elem;
        asdl_seq * seq;
        if (
            (elem = small_stmt_rule(p))  // small_stmt
        ...
        D(fprintf(stderr, "%*c%s _gather_14[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "small_stmt _loop0_15"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_138: lambda_slash_with_default | lambda_param_with_default+
static void *
